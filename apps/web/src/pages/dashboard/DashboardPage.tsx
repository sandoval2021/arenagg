      ...
      <main className="mx-auto max-w-lg px-4 pt-[max(1rem,env(safe-area-inset-top))]">
        ...
        <section className="relative mt-5 overflow-hidden rounded-2xl bg-[#073B8C] p-5 text-white shadow-md">
          ...
          <div className="relative flex items-center justify-between">
            <div><p className="text-xs font-black uppercase tracking-[.18em] text-blue-100">ArenaGG</p><h2 className="mt-1 text-xl font-black">Sua competição. Sua arena.</h2></div>
        ...
        <section className="mt-7">
          <div className="mb-3"><p className="text-xs font-black uppercase tracking-wider text-[#073B8C]">Sua arena</p><h2 className="text-xl font-black">Meus campeonatos</h2></div>
