...
function Loading() { return <main className="grid min-h-dvh place-items-center bg-white"><LoaderCircle className="h-8 w-8 animate-spin text-[#073B8C]" aria-label="Carregando campeonato" /></main>; }
