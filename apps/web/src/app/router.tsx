...
const Placeholder = ({ title }: { title: string }) => <main className="mx-auto max-w-lg p-6"><h1 className="text-2xl font-black">{title}</h1><p className="mt-2 text-slate-500">Esta área será conectada nas próximas etapas do ArenaGG.</p></main>;
