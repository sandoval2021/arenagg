    ...
    <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-md shadow-slate-200/60">
      ...
      <div className="mt-2 flex items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-3">
        <div className="grid h-20 w-20 shrink-0 place-items-center overflow-hidden rounded-2xl border border-slate-200 bg-white p-1 shadow-sm">
          {visibleLogo ? <img loading="lazy" decoding="async" src={visibleLogo} alt="Preview do escudo" className="h-full w-full rounded-xl object-contain" /> : <Shield className="h-8 w-8 text-slate-300" />}
        </div>
                ...
                return (
                  ...
                  >
                    <span className="mx-auto block aspect-square w-full max-w-[5rem] overflow-hidden rounded-xl bg-slate-950/5">
                      <img loading="lazy" decoding="async" src={shield.url} alt="" className="h-full w-full object-contain" />
                    </span>
            ...
            {shields.data?.map((shield) => {
              ...
              return (
                <button
                  ...
                  title={shield.name}
                >
                  <img loading="lazy" decoding="async" src={shield.url} alt="" className="h-full w-full rounded-xl object-contain" />
