      ...
      <div className="overflow-hidden rounded-[2rem] border border-blue-200 bg-white shadow-lg shadow-blue-100/40">
        ...
        {data && data.groups.length > 0 && (
          <div className="p-3 sm:p-5">
            ...
            <div className="mt-3 flex items-center gap-2 rounded-2xl bg-blue-50 px-3 py-2.5 text-[10px] font-bold text-[#073B8C]"><Sparkles className="h-4 w-4 shrink-0" />Critérios: pontos, vitórias, saldo de gols e gols marcados.</div>
